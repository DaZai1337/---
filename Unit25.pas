...
begin
  ...
  if (FormatDateTime('dd/mm/yyyy', Form25.DateTimePicker1.Date) <> FormatDateTime('dd/mm/yyyy', Form25.DateTimePicker2.Date)) then
    begin
      ...
      DataModule2.ADOTable20.Filter := '[Дата_ремонта]>=' + QuotedStr(DateToStr(form25.datetimepicker1.date)) + 'and [Дата_ремонта]<=' + QuotedStr(DateToStr(form25.datetimepicker2.date)) + '';
    end
  else
  begin
    DataModule2.ADOTable20.Filtered:=true;
