...
begin
  ...
  form1.dbgrid5.SelectedField.DataSet.FieldByName('ФИО').text:=form14.edit1.text;
  form1.dbgrid5.SelectedField.DataSet.FieldByName('Дата_рождения').Text:=FormatDateTime('dd/mm/yyyy', Form14.DateTimePicker1.Date);
  form1.dbgrid5.SelectedField.DataSet.FieldByName('Телефон').text:=form14.edit2.text;
  form1.dbgrid5.SelectedField.DataSet.FieldByName('Кабинет').text:=form14.edit3.text;
  form1.dbgrid5.SelectedField.DataSet.FieldByName('id_Должность').value:=form14.dblookupcombobox1.KeyValue;
  //form1.dbgrid5.SelectedField.DataSet.FieldByName('id_Отдел').value:=form14.dblookupcombobox2.KeyValue;
