...
begin
  if (form1.dbgrid5.SelectedField.DataSet.FieldByName('ФИО').text<>'None') then
    begin
      Datamodule2.AdoTable1.First;
      while not (Datamodule2.AdoTable1.Eof) do
        begin
          Datamodule2.AdoTable1.Edit;
          if (datamodule2.adotable1.fields.fields[7].text = form1.dbgrid5.SelectedField.DataSet.FieldByName('ID_Сотрудник').Text) then datamodule2.adotable1.Fields.Fields[7].text:='33';
