...
begin
  ...
  form1.dbgrid6.SelectedField.DataSet.FieldByName('Поставщик').text:=form16.edit6.text;
  form1.dbgrid6.SelectedField.DataSet.FieldByName('Адрес').text:=form16.edit7.text;
  form1.dbgrid6.SelectedField.DataSet.FieldByName('Телефон').text:=form16.edit8.text;
