...
begin
  ...
  form1.dbgrid1.SelectedField.DataSet.FieldByName('id_Тип').value:=IntToStr(StrToInt(VarToStr(dblookupcombobox1.KeyValue)));
  form1.dbgrid1.SelectedField.DataSet.FieldByName('Название').text:=form6.edit1.text;
  form1.dbgrid1.SelectedField.DataSet.FieldByName('Инвентарный_номер').text:=form6.edit2.text;
  form1.dbgrid1.SelectedField.DataSet.FieldByName('Серийный_номер').text:=form6.edit3.text;
  form1.dbgrid1.SelectedField.DataSet.FieldByName('Стоимость').text:=form6.edit4.text;
  form1.dbgrid1.SelectedField.DataSet.FieldByName('Дата_покупки').Text:=FormatDateTime('dd/mm/yyyy', Form6.DateTimePicker1.Date);
  form1.dbgrid1.SelectedField.DataSet.FieldByName('Гарантийный_срок').text:=form6.edit5.text;
  form1.dbgrid1.SelectedField.DataSet.FieldByName('id_Поставщик').value:=form6.dblookupcombobox2.KeyValue;
